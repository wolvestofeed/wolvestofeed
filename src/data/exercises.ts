...
export const exercises: Exercise[] = [
    ...
    },
    {
        ...
        rightNowDescription:
            "Something just happened: you snapped, shut down, overdrank, scrolled, or froze. Instead of hating yourself, this exercise walks backward from what you just did to the emotions, thoughts, and core belief underneath. It's a way to see the wiring clearly enough to change one part of the loop.",
        steps: [
            { instruction: "Name the reality you're experiencing right now.", prompt: "What is the situation or outcome you're living in?", rightNowInstruction: "Name what just happened.", rightNowPrompt: "What just happened that you're not proud of - yelling, scrolling, drinking, shutting down, picking a fight, checking out? Name the behavior." },
            { instruction: "What behaviors are creating this reality?", prompt: "What are you doing (or not doing) that maintains this?", rightNowInstruction: "What behaviors led up to this?", rightNowPrompt: "What actions or patterns led up to this moment? List one to three." },
            { instruction: "What emotions are driving those behaviors?", prompt: "Name the emotional fuel behind the action.", rightNowInstruction: "What emotions were driving those behaviors?", rightNowPrompt: "What were you feeling right before - angry, scared, ashamed, lonely, bored, numb? Name the dominant emotion." },
            { instruction: "What feelings sit underneath those emotions?", prompt: "Dig deeper — what's the quieter feeling below the surface emotion?", rightNowInstruction: "What feelings sit underneath those emotions?", rightNowPrompt: "Under that emotion, what quieter feeling was present - disappointment, grief, humiliation, hopelessness, jealousy, exhaustion? Write it." },
            { instruction: "What thoughts generate those feelings?", prompt: "What story are you telling yourself?", rightNowInstruction: "What thoughts generated those feelings?", rightNowPrompt: "What sentence was running through your head? Start with something like 'I always…', 'They never…', or 'I'll never…'. Write the exact thought." },
            { instruction: "What core belief sits at the root?", prompt: "Name it. This is the foundation of the whole sequence.", rightNowInstruction: "What core belief sits at the root?", rightNowPrompt: "If that thought were always true, what would it say about you or the world? Examples: 'I'm not enough,' 'No one stays,' 'It's all on me,' 'Nothing works out for me.' Write your core belief." },
            { instruction: "Which layer is easiest for you to shift right now?", prompt: "You don't have to change the deepest layer first. Start where you can.", rightNowInstruction: "Which layer is easiest for you to shift right now?", rightNowPrompt: "Looking at thought, feeling, emotion, and behavior, choose the one layer you feel most able to nudge 1% differently next time and describe the tiny change you want to try." },
        ],
    },
    ...
    // ═══════════════════════════════════════
    {
        ...
        steps: [
            { instruction: "Name what burned.", prompt: "Example: My belief that if I meditate daily and keep my vows, I'll be protected from career failure.", rightNowInstruction: "Name what burned.", rightNowPrompt: "Something just collapsed spiritually. A belief, a practice, your faith in how life works. Right now, in plain words, name what feels dead or gone." },
            { instruction: "Acknowledge the grief.", prompt: "Example: I feel betrayed by the universe. I did everything 'right' and still fell.", rightNowInstruction: "Acknowledge the grief.", rightNowPrompt: "Notice what's moving in your chest, throat, or gut as you look at that loss. Write one sentence starting with 'I feel…'. Give yourself permission to be angry, sad, betrayed, or numb." },
            { instruction: "Identify what survived.", prompt: "What remains when the structure is gone? Your breath? Your vows? Capacity to sit? Compassion despite pain?", rightNowInstruction: "Identify what survived.", rightNowPrompt: "Even in this wreckage, something hasn't burned. Your breath? A value you refuse to drop? One practice you can still do? Name one thing that's still quietly alive in you right now." },
        ],
    },
    {
        id: "kensho-tracking",
        ...
        steps: [
            ...
            { instruction: "What opened?", prompt: "What insight, feeling, or state became available?", rightNowInstruction: "What opened?", rightNowPrompt: "In that moment, what did you see or feel? Describe it in one or two simple lines." },
            { instruction: "What did it show you?", prompt: "What truth or possibility did that moment reveal?", rightNowInstruction: "What did it show you?", rightNowPrompt: "What did that glimpse reveal about yourself or the world that still feels true, even if your current life doesn't match it?" },
            { instruction: "What followed?", prompt: "Did you try to hold onto it? Did it fade? Did it create pressure to 'live up to' the experience?", rightNowInstruction: "What followed?", rightNowPrompt: "What happened after that moment? Did life change? Did you ignore it? Does remembering it create pressure or relief?" },
            { instruction: "Reflect: Can these moments simply be true glimpses, without obligation?", prompt: "Do your kensho moments create pressure to 'live up' to what you saw? Or can they simply be true glimpses?", rightNowInstruction: "Reflection.", rightNowPrompt: "Are you using this glimpse to beat yourself up, or can you let it be a true moment that happened without needing you to live up to it?" },
        ],
    },
    {
    ...
    },
    {
        ...
        steps: [
            { instruction: "Name your current edge in Spirit.", prompt: "Where are you on the edge right now with your spiritual life?" },
            { instruction: "Lever 1 — Thinking (Paradigm Shift): What mental model could I shift?", prompt: "Example: From 'Practice should deliver success' to 'Practice develops capacity to stand in the fire without collapsing.'" },
            { instruction: "Lever 2 — Feeling (Perspective Change): What emotional interpretation could I reframe?", prompt: "Example: From 'I feel abandoned by the sacred' to 'I'm learning to carry teachings without institutional support.'" },
            { instruction: "Lever 3 — Body (Physiological Reset): What practice could regulate my nervous system right now?", prompt: "Example: 10 minutes seated zazen, breath work, walking meditation, prostrations." },
        ],
    },
    ...
    // ═══════════════════════════════════════
    {
        ...
        steps: [
            { instruction: "Revenue streams — Single client? Multiple?", prompt: "Assess vulnerability (High / Medium / Low) and a strengthening action.", rightNowInstruction: "Revenue streams.", rightNowPrompt: "Right now, where is your money coming from - one client, multiple sources, or nothing steady? Describe your situation in a sentence." },
            { instruction: "Cash reserves — Months of runway?", prompt: "Be honest about your buffer. What could you do to extend it?", rightNowInstruction: "Cash reserves.", rightNowPrompt: "How many months could you survive if all income stopped today? Enter the number, even if it's zero." },
            { instruction: "Partnership structure — Solo? Co-founder? Team?", prompt: "Vulnerability level and what needs clarity?", rightNowInstruction: "Partnership structure.", rightNowPrompt: "Are you solo, with a co-founder, or on a team? If there's tension or confusion, name it in one line." },
            { instruction: "Innovation vs. profit — Cutting-edge or sustainable?", prompt: "Where should you shift to create durability?", rightNowInstruction: "Innovation vs. profit.", rightNowPrompt: "Is your work mostly cutting-edge and risky, mostly focused on making money, or somewhere in between? Describe it in a few words." },
            { instruction: "Emotional attachment — Identity-fused or boundaried?", prompt: "How attached is your identity to this particular career form?", rightNowInstruction: "Emotional attachment.", rightNowPrompt: "Is your identity fused with this work, or can you see it as separate from who you are? Write a sentence about how attached you feel." },
            { instruction: "Market dependence — Niche or broad?", prompt: "Is your market concentration a risk?", rightNowInstruction: "Market dependence.", rightNowPrompt: "Are you dependent on one niche market, or do you have options? Describe your current dependence in a sentence." },
            { instruction: "Name your most vulnerable strand right now.", prompt: "Which element could tear first?", rightNowInstruction: "Most vulnerable strand right now.", rightNowPrompt: "Out of money, partnerships, identity, or market, what feels most fragile today? Name that strand." },
            { instruction: "One action to strengthen it.", prompt: "What's the single most impactful thing you could do?", rightNowInstruction: "One action.", rightNowPrompt: "What's one small move you could take in the next 24 hours to strengthen that strand - an email, a boundary, a backup plan, a resume update? Describe the action." },
        ],
    },
    {
    ...
    },
    {
        ...
        steps: [
            { instruction: "Acknowledge the shredded web.", prompt: "Name what's gone. Grieve it if needed. Don't bypass the loss.", rightNowInstruction: "Acknowledge the shredded web.", rightNowPrompt: "Something you built - a job, business, or project - just tore apart or is clearly ending. Write one sentence that honors the loss: 'What hurts most about this ending is…'" },
            { instruction: "Identify your intact silk.", prompt: "What skills, values, and capacities do you still have?", rightNowInstruction: "Identify your intact silk.", rightNowPrompt: "Even with the web gone, your 'silk' is still here. List three skills, values, or capacities you still have today, even in pain." },
            ...
            { instruction: "Land and spin.", prompt: "When you find solid ground (even temporary), start building the next web — smaller, smarter, durable.", rightNowInstruction: "Land and spin.", rightNowPrompt: "Choose one action from your list that you're willing to take first. Name it, and if possible, set a time you'll do it." },
        ],
    },
    {
        ...
        steps: [
            { instruction: "Name your current edge in Career.", prompt: "Where are you on the edge right now with your work life?" },
            { instruction: "Lever 1 — Thinking (Paradigm Shift): What mental model could I shift?", prompt: "Example: From 'I need one big breakthrough' to 'I need multiple small webs that create redundancy.'" },
            { instruction: "Lever 2 — Feeling (Perspective Change): What emotional interpretation could I reframe?", prompt: "Example: From 'I'm a failure because webs keep tearing' to 'I'm a spider who survives storms and knows how to spin again.'" },
            { instruction: "Lever 3 — Body (Physiological Reset): What action could ground me in my capacity right now?", prompt: "Example: Update resume, send 3 emails, practice pitch out loud, review skills inventory." },
        ],
    },
    ...
    },
    {
        ...
        steps: [
            { instruction: "Name the failed teammate.", prompt: "What part of your body or physicality feels like a disappointment or liability?", rightNowInstruction: "Name the failed teammate.", rightNowPrompt: "Which part of your body feels like it betrayed you - knee, gut, back, wrist, heart, overall energy? Name it." },
            { instruction: "Write the blame story.", prompt: "What do you quietly resent this part of your body for? Example: My wrist failed me when I needed it most. My gut humiliates me.", rightNowInstruction: "Write the blame story.", rightNowPrompt: "Give that blame one honest sentence: 'I'm mad at you because…' Let it be raw." },
            { instruction: "Rewrite as care.", prompt: "What if this part of your body isn't broken — it's adapted, sensitive, or trying to tell you something? Example: Blame: 'My gut is weak and unreliable' → Care: 'My gut is a sensitive early-warning system for stress I haven't processed.'", rightNowInstruction: "Rewrite as care.", rightNowPrompt: "Now translate that blame into care. Start with: 'What you might be trying to tell me is…' Write a version where this body part is trying to protect you or warn you." },
            { instruction: "One act of care.", prompt: "What's one thing you could do this week to care for (not fix) this part of your body?", rightNowInstruction: "One act of care.", rightNowPrompt: "Name one thing you can do in the next 24 hours that cares for (not fixes) this part - rest, ice, heat, stretching, food, medical support, saying no, gentle movement. Write it." },
        ],
    },
    {
        id: "body-lever-work",
        ...
        steps: [
            { instruction: "Name your current edge in Body.", prompt: "Where are you on the edge right now with your physical self?" },
            { instruction: "Lever 1 — Thinking (Paradigm Shift): What mental model could I shift?", prompt: "Example: From 'My body should return to what it was' to 'My body is in a new form and I need to learn how to inhabit it.'" },
            { instruction: "Lever 2 — Feeling (Perspective Change): What emotional interpretation could I reframe?", prompt: "Example: From 'I'm ashamed my body can't perform like before' to 'I honor my body's seasons and adapt my expectations.'" },
            { instruction: "Lever 3 — Body (Physiological Reset): What practice matches my actual season right now?", prompt: "Example: Gentle movement, restorative yoga, walking, breathwork, adequate sleep." },
        ],
    },
    ...
    // ═══════════════════════════════════════
    {
        ...
        steps: [
            ...
            { instruction: "Casual layer — who and when?", prompt: "Quality (1-10) and what's missing?", rightNowInstruction: "Casual layer.", rightNowPrompt: "Who do you spend time with casually but don't go deep with? List one or two names, last contact, and quality from 1–10." },
            { instruction: "Vulnerable layer — who and when?", prompt: "Quality (1-10) and what's missing?", rightNowInstruction: "Vulnerable layer.", rightNowPrompt: "Who have you had a real, honest conversation with recently? List one or two names, last contact, and quality from 1–10." },
            { instruction: "Sacred layer — who and when?", prompt: "Quality (1-10) and what's missing?", rightNowInstruction: "Sacred layer.", rightNowPrompt: "Who knows you at the deepest level - your fears, failures, and true self? List names, last contact, and quality from 1–10." },
            { instruction: "Which layer is most depleted?", prompt: "Name it.", rightNowInstruction: "Which layer is most depleted?", rightNowPrompt: "Looking at your answers, which layer feels most empty or neglected - surface, casual, vulnerable, or sacred? Type the layer name." },
    ...
    },
    {
        ...
        steps: [
            { instruction: "Who do I howl to when I need help?", prompt: "Who actually picks up the phone? Who shows up?", rightNowInstruction: "Who do I howl to when I need help?", rightNowPrompt: "If a crisis hit you tonight, who would you reach out to? Who actually tends to respond? List their names." },
            { instruction: "Who howls to me?", prompt: "Who comes to me with their struggles? Who trusts me?", rightNowInstruction: "Who howls to me?", rightNowPrompt: "Who comes to you with their struggles? Who trusts you with their real life? List their names." },
            { instruction: "Where is my pack?", prompt: "I have a clear pack / I'm between packs (transition, relocation, life phase shift) / I'm a lone wolf right now (no consistent pack)", rightNowInstruction: "Where is my pack?", rightNowPrompt: "Based on this, which phrase fits you best right now? Type one:\n• I have a clear pack\n• I'm between packs (transition/relocation/life shift)\n• I'm a lone wolf right now (no consistent pack)." },
            { instruction: "If I'm a lone wolf, is it by choice or circumstance?", prompt: "Describe.", rightNowInstruction: "If I'm a lone wolf, is it by choice or circumstance?", rightNowPrompt: "If you named yourself a lone wolf, complete this sentence: 'I'm alone right now because…'" },
    ...
    },
    {
        ...
        steps: [
            { instruction: "Send a clear howl.", prompt: "Reach out to someone specific with a vulnerable, direct message. Example: 'I've been isolated lately and could use some real conversation. Can we talk this week?' Who will you howl to?", rightNowInstruction: "Choose one person.", rightNowPrompt: "Right now, who is one person you could send a real, honest message to - even if you're not sure they'll respond? Type their name." },
            { instruction: "Howl without expectation.", prompt: "Send the call, but don't collapse if there's no response. Some howls echo into silence.", rightNowInstruction: "Draft the howl.", rightNowPrompt: "Write a one or two sentence message that tells the truth without drama. For example: 'I've been struggling and could use some real conversation this week. Are you open to that?' Now write your version." },
            { instruction: "Track responses.", prompt: "Who responds? Who doesn't? This data tells you where your pack might actually be.", rightNowInstruction: "Decide what to do with it.", rightNowPrompt: "Look at what you wrote. Do you want to send it, save it for later, or delete it? Type your choice." },
            { instruction: "Keep howling.", prompt: "Isolation deepens when we stop calling. Even if responses are rare, keep sending the signal.", rightNowInstruction: "Track responses (if you send it).", rightNowPrompt: "If you choose to send it, come back later and note who responded and who didn't. This is data about where your true pack might be." },
        ],
    },
    {
        ...
        steps: [
            { instruction: "Name your current edge in Intimacy.", prompt: "Where are you on the edge right now with connection and relationships?" },
            { instruction: "Lever 1 — Thinking (Paradigm Shift): What mental model could I shift?", prompt: "Example: From 'If I'm vulnerable I'll be abandoned' to 'Vulnerability is the only path to real connection, and some people will stay.'" },
            { instruction: "Lever 2 — Feeling (Perspective Change): What emotional interpretation could I reframe?", prompt: "Example: From 'I'm defective because I'm alone' to 'I'm in a lone wolf season, learning survival skills I'll carry forever.'" },
            { instruction: "Lever 3 — Body (Physiological Reset): What embodied practice could ease isolation?", prompt: "Example: Hug my dog, hand on heart breathing, schedule one in-person coffee, attend a group activity." },
        ],
    },
    ...
    },
    {
        ...
        steps: [
            { instruction: "Wisdom / Teaching — What am I planting? Who receives it? What could grow?", prompt: "Map this domain of your legacy.", rightNowInstruction: "Wisdom / Teaching.", rightNowPrompt: "What wisdom or teaching are you planting right now? Who receives it? What could grow from it?" },
            { instruction: "Relationships — What am I planting?", prompt: "Map the relational legacy you're creating.", rightNowInstruction: "Relationships.", rightNowPrompt: "What are you planting in your relationships? Who receives it? What could grow from it?" },
            { instruction: "Creative Work — What am I planting?", prompt: "Map the creative legacy.", rightNowInstruction: "Creative Work.", rightNowPrompt: "What creative work are you putting into the world? Who or what receives it? What might grow from it?" },
            { instruction: "Land / Place — What am I planting?", prompt: "Map your legacy in the places you've touched.", rightNowInstruction: "Land / Place.", rightNowPrompt: "How are you impacting the places or land you touch? Who or what receives that impact? What could grow from it?" },
            { instruction: "Values / Ethics — What am I planting?", prompt: "Map the values you're transmitting.", rightNowInstruction: "Values / Ethics.", rightNowPrompt: "What values or ethics are you living out loud? Who receives that example? What could grow from it?" },
            { instruction: "Service — What am I planting?", prompt: "Map your legacy of service.", rightNowInstruction: "Service.", rightNowPrompt: "What forms of service are you offering? Who receives them? What could grow from them?" },
    ...
    },
    {
        ...
        steps: [
            { instruction: "Name the old feathers.", prompt: "What identities, titles, or roles are you clinging to that need to molt? Examples: 'I'm the person who will build a multi-million dollar business.' 'I'll be the patriarch of a large family.' 'I'll retire with security and comfort.'", rightNowInstruction: "Name the old feathers.", rightNowPrompt: "What identities, titles, or roles are you clinging to that may need to molt? For example: 'I'm the guy who will build a multi-million-dollar business,' 'I'll retire with security and comfort.' List yours." },
            { instruction: "Acknowledge the grief.", prompt: "These were real dreams. It's okay to mourn what didn't happen. How do you feel about letting them go?", rightNowInstruction: "Acknowledge the grief.", rightNowPrompt: "These were real dreams. In a few lines, say how it feels to imagine letting them go. Let sadness, anger, or relief be honest." },
            { instruction: "Release.", prompt: "Write a simple release statement: 'I release the identity of __________. I honor what it meant to me, and I let it fall.'", rightNowInstruction: "Release.", rightNowPrompt: "Write a simple release statement: 'I release the identity of ________. I honor what it meant to me, and I let it fall.'" },
            { instruction: "What grows in its place?", prompt: "After molting, what new feathers are emerging? Examples: 'I'm someone who meaningfully touches the lives close to me.' 'I'm a wisdom-keeper who shares what I've learned.' 'I embody resilience and open-heartedness despite my position in life.'", rightNowInstruction: "What grows in its place?", rightNowPrompt: "What new identity or way of seeing yourself is emerging? For example: 'I'm someone who meaningfully touches the lives close to me,' or 'I'm a wisdom-keeper who shares what I've learned.' Write your new feather." },
        ],
    },
    {
        ...
        steps: [
            { instruction: "Name your current edge in Legacy.", prompt: "Where are you on the edge right now with your sense of legacy and long-term meaning?" },
            { instruction: "Lever 1 — Thinking (Paradigm Shift): What mental model could I shift?", prompt: "Example: From 'Legacy = wealth and heirs' to 'Legacy = the quality of presence and wisdom I offer.'" },
            { instruction: "Lever 2 — Feeling (Perspective Change): What emotional interpretation could I reframe?", prompt: "Example: From 'I've failed because I didn't build what I planned' to 'I've succeeded at staying open-hearted and generous despite immense difficulty.'" },
            { instruction: "Lever 3 — Body (Physiological Reset): What embodied practice connects me to long-term meaning?", prompt: "Example: Sit by water and breathe, stack stones in creek bed, write letter to future self, mentor one person this month." },
        ],
    },
    // ═══════════════════════════════════════
    ...
    // ═══════════════════════════════════════
    {
        ...
        steps: [
            ...
            { instruction: "Define one daily act.", prompt: "Make it small enough to do even on your worst day. Examples: 5 minutes of breath work, one honest text to a friend, 10 minutes of walking, writing one sentence of reflection." },
            { instruction: "Commit to the stretch.", prompt: "Write your commitment: 'For the next 30 days, I will [daily act] as my way of working the edge of [domain]. I don't need to solve it. I need to stay with it.'" },
        ],
    },
];
